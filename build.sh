...
gcc -m32 -c ./src/utils/color.c -o ./build/obj/color.o
ld -m elf_i386 -T ./src/boot/linker.ld ./build/boot/boot.o ./build/obj/terminal.o ./build/obj/main.o ./build/obj/keyboard.o ./build/obj/stdlib.o  ./build/obj/color.o -o Lennox.bin -nostdlib
